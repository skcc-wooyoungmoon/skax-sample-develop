package scm.common.biz.file.controller;
...
import scm.common.app.dto.ExceptionDto;
import scm.common.biz.file.controller.port.FileServicePort;
import scm.common.biz.file.domain.FileDownload;
import scm.common.biz.file.domain.FileModel;
import scm.common.biz.file.controller.request.FileDownloadRequest;
import scm.common.biz.file.controller.response.FileUploadResponse;
    ...
    public ApiResponse<FileUploadResponse> uploadFile(
        ...
        try {
            ...
            return ApiResponse.fail(HttpStatus.INTERNAL_SERVER_ERROR,
                    ExceptionDto.builder().message("파일 저장 중 오류가 발생 하였습니다.").build());
        }
    }
