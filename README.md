...
```text
skax-sample-develop/
|- skax-frontend/           # 관리자/사용자 웹
|- skax-backend/            # 게이트웨이, 도메인 서비스, 공통 서비스
|- skax-agent/              # AI Agent 관련 영역
|- skax-devops/             # Helm chart, CI/CD, 운영 자산
`- docs/                    # 아키텍처/개발/운영 가이드
```
...
- [CI/CD Workflow 설정 가이드](docs/10.ci-cd-workflow-guide.md) ← **GitHub Actions 시작 여기서**
- 설치/개발 환경 가이드
- 코딩/네이밍/예외 처리 규칙
